<x-filament::page>
    <div class="bg-white shadow rounded-xl p-6">
        ...
        <div class="flex justify-between items-start mb-2">
            <div>
                <h2 class="text-l text-gray-800">
                    No. Referensi: <b>{{ $quotation->reference }}<b>
                </h2>
            </div>

            <button wire:click="downloadPdf"
                class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                <x-heroicon-o-printer class="w-5 h-5 mr-2" /> Cetak PDF
            </button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-2">
            <div>
                <h3 class="font-bold mb-2">Info Perusahaan</h3>
                ...
                <p class="font-normal">Telepon: +62 812 3456 7890</p>
            </div>

            <div>
                <h3 class="font-bold mb-2">Info Pelanggan</h3>
            ...
            <div>
                <h3 class="font-bold mb-2">Rincian Faktur</h3>
                <p class="w-full font-normal sm:w-1/3 border-t border-gray-300 pt-4">Penawaran:
                    <strong>{{ $quotation->reference }}</<strong>>
                </p>
                <p class="font-normal">Tanggal:
                ...
                <p class="font-normal">Status Pembayaran:</p>
            </div>
        </div>
            ...
            <table class="table-auto w-full border border-gray-300 text-sm">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border px-3 py-2">Harga Satuan Bersih</th>
        ...
        <div class="mt-6 flex justify-end">
            <div class="w-full sm:w-1/3 border-t border-gray-300 pt-4">
                <div class="flex justify-between mb-2">
                    <span>Diskon ({{ $quotation->discount_percentage ?? 0 }}%)</span>
