...
use App\Filament\Resources\Purchases\PurchaseReturnResource\Pages;
use App\Filament\Resources\Purchases\PurchaseReturnResource\RelationManagers;
...
class PurchaseReturnResource extends Resource
{
    ...
    protected static ?string $tenantRelationshipName = 'purchases_return';
            ...
            ->schema([
                TextInput::make('reference')
                    ...
                    ->placeholder(function () {
                        $lastId = \App\Models\Purchases\PurchaseReturn::max('id') ?? 0;
                        $nextId = $lastId + 1;
                        return 'PRT' . str_pad($nextId, 4, '0', STR_PAD_LEFT);
                    }),
